	...
	public static void main(String[] args) {
		...
		do {
			...
			for (int i = 0; i < 2; i++) {
				...
				case 0:
					System.out.println("Attacking hero " + fighting[i].getName() + " - Stricke is " + fighting[i].strikeHero());
					fighting[i + 1].setHealth(fighting[i + 1].getHealth() - fighting[i].strikeHero());
					System.out.println("Health of hero " + fighting[i + 1].getName() + " is " + fighting[i + 1].getHealth());
					break;
